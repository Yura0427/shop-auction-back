...
export class OllaParserSettingsSeed1653991138735 implements MigrationInterface {
  ...
  public async up(): Promise<void> {
    ...
    const params: IParameter = {
      name: ParametersNameEnum.parser,
      settings: {
        olla: { createNewProducts: true, updateOldProducts: true, updatePhoto: false, parserLimit: 10 }
      },
    };
